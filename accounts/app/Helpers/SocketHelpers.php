...
class SocketHelpers
{
    ...
    public static function sendSocketDeleteComment($currentUserId = '', $id_post = '', $id_comment = '', $id_parent_comment = '')
    {
        $socketHelper = new self();
        SendSocketH(['id_post' => $id_post,'currentUserId' => $currentUserId,'id_comment' => $id_comment,'id_parent_comment' => $id_parent_comment], [], 'deleteCommentAll');
    }
    public static function sendSocketDeleteNewsfeed($currentUserId = '', $id_post = '')
    {
        $socketHelper = new self();
        SendSocketH(['id_post' => $id_post,'currentUserId' => $currentUserId], [], 'deleteNewsfeedAll');
    }  
    public static function sendSocketloadNewsfeed($currentUserId = '', $id_post = '')
    {
        $socketHelper = new self();
        SendSocketH(['id_post' => $id_post,'currentUserId' => $currentUserId], [], 'loadNewsfeedAll');
    }
    ...
    {
        $socketHelper = new self();
        SendSocketH($data, $id_client, $event);
    }
