...
@section('content')
<style>
   body.admin-modern .page-title {
        display: block !important;
   }
   body.admin-modern .admin-content .card-box {
        padding: 20px !important;
        border: 1px solid rgba(54, 64, 74, 0.05) !important;
            ...
            <div class="card-box">
                    <form action="admin/role/submit/{{$id}}" method="post" data-parsley-validate novalidate>
                        ...
                        <div class="form-group text-right m-b-0" style="margin-top: 10px">
                            <button class="btn btn-default waves-effect waves-light" type="submit">{{lang('dt_save')}}</button>
                            <button type="reset" class="btn btn-primary waves-effect button waves-light m-l-5">
