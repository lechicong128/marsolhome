...
<div class="mod-page-header">
    ...
    <div class="mod-page-actions">
        <a href="admin/house_orientations/detail" class="mod-btn mod-btn-primary dt-modal">
            <i class="fa fa-plus"></i> Thêm hướng nhà
        </a>
    </div>
</div>
...
<div class="ul-card">
    ...
    <div class="table-responsive">
        <table id="table_house_orientation" class="table">
            <thead>
                <tr>
                    <th class="text-center">{{lang('dt_stt')}}</th>
                    <th class="text-center">{{lang('Tên hướng nhà')}}</th>
...
@section('script')
    <script>
        var fnserverparams = {};
        var oTable;
        oTable = InitDataTable('#table_house_orientation', 'admin/house_orientations/getHouseOrientations', {
            'order': [
                [0, 'desc']
            ],
            'responsive': true,
            "ajax": {
                "type": "POST",
                "url": "admin/house_orientations/getHouseOrientations",
                "data": function (d) {
