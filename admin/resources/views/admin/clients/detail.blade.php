                                    ...
                                    <div class="col-md-4">
                                        <div class="col-md-12">
                                            <div class="form-group hide">
                                                ...
                                                <input type="text" name="address" id="address" value="{{!empty($client) ? $client['address'] : ''}}" class="form-control address">
                                            </div>
                                            <div class="form-group">
...
@section('script')
    <script>
        ...
        $(document).on('input', '[name=type_client]', function (e) {
            var value = $(this).val();
            if(value == 1){
                $(".warp_partner").addClass('hide');
            } else {
                $(".warp_partner").removeClass('hide');
            }
        });
    </script>
@endsection
