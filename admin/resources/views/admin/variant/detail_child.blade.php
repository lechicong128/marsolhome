<form id="variantOptionsForm" action="admin/variant/submit_child/{{$idVariant}}/{{$id}}" method="post" data-parsley-validate novalidate>
    {{csrf_field()}}
    <style>
        .tab-btn {
            flex: 1;
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <input type="hidden" name="id" value="{{!empty($VariantOptions) ? $VariantOptions->id : 0}}" >
                                ...
                                <div id="tab-info-{{$lang->code}}" class="tab-pane fade {{$lang->is_default ? 'in active' : ''}}">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name[{{$lang->code}}]"
                                               id="name_{{$lang->code}}"
                                               class="form-control"
                                               value="{{$VariantOptions->translations[$lang->code]['name'] ?? ''}}"/>
                                    </div>
                                </div>
                            @endforeach
                        </div>
