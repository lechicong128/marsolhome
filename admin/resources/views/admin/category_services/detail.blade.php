<form id="CategoryServiceForm" action="admin/category_service/submit/{{!empty($id) ? $id : '0'}}" method="post" data-parsley-validate novalidate>
    {{csrf_field()}}
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label for="code">{{lang('c_code_category_services')}}</label>
                            <input type="text" name="code" class="form-control code" value="{{!empty($category) ? $category->code : ''}}">
                        </div>
                        <div class="form-group">
                            <label for="name">{{lang('c_name_category_services')}} <i class="text-danger required">*</i></label>
                        ...
                        <div class="form-group">
                            <label for="content">{{lang('c_content_category_services')}}</label>
