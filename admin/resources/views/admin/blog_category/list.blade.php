...
<div class="mod-page-header">
    ...
    <div class="mod-page-actions">
        <a href="admin/blog_category/detail" class="mod-btn mod-btn-primary dt-modal">
            <i class="fa fa-plus"></i> Thêm loại bài viết
        </a>
    </div>
</div>
...
<div class="ul-card">
    ...
    <div class="table-responsive">
        <table id="table_blog_category" class="table">
            <thead>
                <tr>
                    <th class="text-center">{{lang('dt_stt')}}</th>
                    <th class="text-center">{{lang('dt_name_blog_category')}}</th>
...
@section('script')
    <script>
        var fnserverparams = {};
        var oTable;
        oTable = InitDataTable('#table_blog_category', 'admin/blog_category/getTable', {
            'order': [
                [0, 'desc']
            ],
            'responsive': true,
            "ajax": {
                "type": "POST",
                "url": "admin/blog_category/getTable",
                "data": function (d) {
