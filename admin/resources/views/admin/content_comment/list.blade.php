<div class="mod-page-header">
    <div class="mod-page-header-left">
        <h1 class="mod-page-title">{{lang('dt_content_comment')}}</h1>
    </div>
    <div class="mod-page-actions">
        <a href="admin/content_comment/detail" class="mod-btn mod-btn-primary dt-modal">
            <i class="fa fa-plus"></i> {{ lang('dt_add_content_comment') }}
        </a>
    </div>
</div>
...
<div class="ul-card" style="min-height:unset !important">
    ...
    <div class="table-responsive">
        <table id="table_content_comment" class="table">
            <thead>
                <tr>
                    <th class="text-center">{{lang('dt_stt')}}</th>
                    <th class="text-center">{{lang('dt_name_content_comment')}}</th>
