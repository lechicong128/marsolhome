...
<div class="mod-page-header">
    ...
    <div class="mod-page-actions">
        <a href="admin/interior_amenities/detail" class="mod-btn mod-btn-primary dt-modal">
...
<div class="ul-card">
    ...
    <div class="table-responsive">
        <table id="table_interior_amenity" class="table">
            <thead>
                <tr>
...
@section('script')
    <script>
        var fnserverparams = {};
        var oTable;
        oTable = InitDataTable('#table_interior_amenity', 'admin/interior_amenities/getInteriorAmenities', {
            'order': [
                [0, 'desc']
            ],
            'responsive': true,
            "ajax": {
                "type": "POST",
                "url": "admin/interior_amenities/getInteriorAmenities",
                "data": function (d) {
