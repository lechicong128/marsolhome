    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="admin/transaction_payment/list">{{$title}}</a></li>
    ...
    <div class="row">
        <div class="col-sm-12">
            <ul class="nav nav-tabs">
                ...
                <li class="H-search cursor"><a style="color: #ffbd4a !important;" data-toggle="tab" data-id="0">{{lang('status_not_payment')}}
                        (<b class="count_0">0</b>)</a></li>
                <li class="H-search cursor"><a style="color: #81c868 !important;" data-toggle="tab" data-id="1">{{lang('payment_success')}}
                        (<b class="count_1">0</b>)</a></li>
                <li class="H-search cursor"><a style="color: red !important;" data-toggle="tab" data-id="2">{{lang('payment_not_enough')}}
            ...
            <div class="card-box table-responsive">
                ...
                <table id="table_transaction_payment" class="table table-bordered table_transaction_payment">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">{{lang('amount_need_payment')}}</th>
                            <th class="text-center">{{lang('amount_payment')}}</th>
...
@section('script')
    <script>
        ...
        var oTablePayment;
        oTablePayment = InitDataTable('#table_transaction_payment', 'admin/transaction_payment/getList', {
            'order': [
                [0, 'desc']
            ],
            'responsive': true,
            "ajax": {
                "type": "POST",
                "url": "admin/transaction_payment/getList",
                "data": function (d) {
            ...
            columnDefs: [
                ...
                { data: 'transaction', name: 'transaction', orderable: false, width: "250px" },
                {
                    "render": function (data, type, row) {
                        return `<div class="text-center">${data}</data>`;
                    },
                ...
                },
                {
                    ...
                    data: 'amount', name: 'amount', width: "140px"
                },
                {
                    "render": function (data, type, row) {
                        return `<div class="text-right">${data}</div>`;
                    },
                    data: 'amount_payment', name: 'amount_payment', width: "140px"
                },
                {
                    "render": function (data, type, row) {
                        return `<div class="text-right">${data}</div>`;
        ...
        $('#table_transaction_payment').on('draw.dt', function () {
            getCountAll();
        });
        ...
        function getCountAll() {
            ...
            $.ajax({
                url: 'admin/transaction_payment/countAll',
                type: 'POST',
                dataType: 'JSON',
                cache: false,
                data: data
