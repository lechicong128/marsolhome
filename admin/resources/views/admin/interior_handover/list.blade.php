...
<div class="mod-page-header">
    ...
    <div class="mod-page-actions">
        <a href="admin/interior_handovers/detail" class="mod-btn mod-btn-primary dt-modal">
            <i class="fa fa-plus"></i> Thêm bàn giao nội thất
        </a>
    </div>
</div>
...
<div class="ul-card">
    ...
    <div class="table-responsive">
        <table id="table_interior_handover" class="table">
            <thead>
                <tr>
                    <th class="text-center">{{lang('dt_stt')}}</th>
                    <th class="text-center">{{lang('Tên bàn giao nội thất')}}</th>
...
@section('script')
    <script>
        var fnserverparams = {};
        var oTable;
        oTable = InitDataTable('#table_interior_handover', 'admin/interior_handovers/getInteriorHandovers', {
            'order': [
                [0, 'desc']
            ],
            'responsive': true,
            "ajax": {
                "type": "POST",
                "url": "admin/interior_handovers/getInteriorHandovers",
                "data": function (d) {
