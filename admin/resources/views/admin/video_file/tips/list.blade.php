        ...
        <div class="col-sm-12">
            <div class="btn-group pull-right m-t-15">
                <a type="button" class="btn btn-default dropdown-toggle waves-effect waves-light dt-modal" data-toggle="dropdown"
                   aria-expanded="false" href="admin/video/detail_tips/0">{{lang('dt_create')}}</a>
            </div>
            <h4 class="page-title text-capitalize">{{lang('video_tips')}}</h4>
            <ol class="breadcrumb">
                <li><a href="admin/dashboard">{{lang('dt_index')}}</a></li>
                <li><a href="admin/video/tips">{{lang('video_tips')}}</a></li>
...
@section('script')
    <script>
        ...
        var oTable;
        oTable = InitDataTable('#table_banner', 'admin/video/getTips', {
            'order': [
                [0, 'desc']
            ],
            'responsive': true,
