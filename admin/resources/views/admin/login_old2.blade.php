            ...
            <div class="wrap-login">
                <form class="form-horizontal m-t-20" action="admin/login" method="post">
                      <span class="img-logo-foso">
                        <img src="admin/assets/images/logo_login.png" width="160"></span>
                    <div class="title_login">{{lang('Đăng nhập')}}</div>
                    <div class="sub_title_login">{{lang('Đăng nhập vào trang quản trị')}} {{get_option('name_company')}}</div>
                    ...
                    @endif
                        <div class="input input-login">
                            ...
                            <input class="input_login_v2 input-login-text" id="input_login_email" name="email" type="text" autocomplete="off"
                                   placeholder="Input email" value="{{!empty($cookieLogin) ? $cookieLogin->email : ''}}" required/>
                        </div>
                    @if($errors->has('email'))
                    ...
                    @endif
                        ...
                        <div class="input input-login input-icons">
                            ...
                            <input class="input-login-text" name="password" type="password" autocomplete="off" placeholder="Nhập password" value="{{!empty($cookieLogin->password) ? decrypt($cookieLogin->password) : ''}}" required/>
                    ...
                    <div class="container-login-form">
                        <div class="wrap-login-form-btn">
                            ...
                            <button type="submit"
                                    class="login-form-btn">{{lang('Đăng nhập')}}</button>
                        </div>
                    </div>
                </form>
            </div>
