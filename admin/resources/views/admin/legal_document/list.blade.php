...
<div class="mod-page-header">
    ...
    <div class="mod-page-actions">
        <a href="admin/legal_documents/detail" class="mod-btn mod-btn-primary dt-modal">
            <i class="fa fa-plus"></i> Thêm giấy tờ pháp lý
        </a>
    </div>
</div>
...
<div class="ul-card">
    ...
    <div class="table-responsive">
        <table id="table_legal_document" class="table">
            <thead>
                <tr>
                    <th class="text-center">{{lang('dt_stt')}}</th>
                    <th class="text-center">{{lang('Tên giấy tờ pháp lý')}}</th>
...
@section('script')
    <script>
        var fnserverparams = {};
        var oTable;
        oTable = InitDataTable('#table_legal_document', 'admin/legal_documents/getLegalDocuments', {
            'order': [
                [0, 'desc']
            ],
            'responsive': true,
            "ajax": {
                "type": "POST",
                "url": "admin/legal_documents/getLegalDocuments",
                "data": function (d) {
