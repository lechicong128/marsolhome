...
@section('page_title', lang('dt_permission'))
@section('content')
    <!-- Page-Title -->
    <div class="mod-page-header">
    <div class="mod-page-header-left">
        <h1 class="mod-page-title">{{lang('dt_permission')}}</h1>
    </div>
    <div class="mod-page-actions">
        <a href="admin/permission/detail" class="mod-btn mod-btn-primary dt-modal">
...
<div class="ul-toolbar">
    <div class="ul-search">
        ...
        <input type="text" id="ul-search-input" placeholder="Tìm theo quyền,tên nhóm quyền...">
    </div>
