...
var editor_short_config = {
    path_absolute: "/",
    selector: 'textarea.editor_short',
    height: 100,
    relative_urls: false,
    plugins: [
        "advlist autolink lists link image charmap print preview hr anchor pagebreak",
    ...
    menubar: false,
    toolbar: "insertfile undo redo | styleselect fontsizeselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link forecolor backcolor",
    setup: function(ed) {
        ed.on('change', function(e) {
            tinyMCE.triggerSave();
        });
...
var editorContent_config = {
    path_absolute: "/",                              // path để mở LFM
    convert_urls: true,
    relative_urls: false,
...
tinymce.init(editorContent_config);
