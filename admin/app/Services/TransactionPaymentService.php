...
class TransactionPaymentService
{
    ...
    public function getList($request)
    {
        try {
            $response = $this->sendRequestToService(
                'get',
                "{$this->baseUrl}/api/transaction_payment/getList",
                $request,
            );
    ...
    public function getListDetailChallengeMe($request)
    {
        try {
            $response = $this->sendRequestToService(
                'get',
                "{$this->baseUrl}/api/transaction_payment/getListDataDetail/{$request->id}",
                $request,
            );
            if (!$response->successful()) {
                return response()->json([
    ...
    public function countAll($request)
    {
        try {
            $response = $this->sendRequestToService(
                'get',
                "{$this->baseUrl}/api/transaction_payment/countAll",
                $request,
            );
            if (!$response->successful()) {
                return response()->json([
    ...
    public function delete($request){
        try {
            $response = $this->sendRequestToService(
                'POST',
                "{$this->baseUrl}/api/transaction_payment/delete",
                $request,
            );
            $data = $response->json();
            return response()->json([
    ...
    public function changeStatus($request){
        try {
            $response = $this->sendRequestToService(
                'POST',
                "{$this->baseUrl}/api/transaction_payment/changeStatus",
                $request
            );
            $data = $response->json();
            return response()->json([
