...
class ChallengeMeService
{
    ...
    public function getList($request)
    {
        try {
            $response = $this->sendRequestToService(
                'get',
                "{$this->baseUrl}/api/challenge_me/getList",
                $request,
            );
    ...
    public function getListDetailChallengeMe($request)
    {
        try {
            $response = $this->sendRequestToService(
                'get',
                "{$this->baseUrl}/api/challenge_me/getListDataDetail/{$request->id}",
                $request,
            );
            if (!$response->successful()) {
                return response()->json([
    ...
    public function countAll($request)
    {
        try {
            $response = $this->sendRequestToService(
                'get',
                "{$this->baseUrl}/api/challenge_me/countAll",
                $request,
            );
            if (!$response->successful()) {
                return response()->json([
    ...
    public function delete($request){
        try {
            $response = $this->sendRequestToService(
                'POST',
                "{$this->baseUrl}/api/challenge_me/delete",
                $request,
            );
            $data = $response->json();
            return response()->json([
