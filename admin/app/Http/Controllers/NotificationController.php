...
class NotificationController extends Controller
{
    ...
    public function loadNoti(){
        ...
        $dtNotification = $dtNotification->map(function ($item) use ($_locale){
            $tran = $item->notification_tran->where('language',$_locale)->first();
            $item->title = !empty($tran) ? $tran['title'] : $item->title;
            $item->content = !empty($tran) ? $tran['content'] : $item->content;
            return $item;
        });
